...
export const extendCosmosProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [
    ...cosmosProtoRegistry,
...
export const protoRegistry: ReadonlyArray<[string, GeneratedType]> = [...extendCosmosProtoRegistry, ...lumProtoRegistry, ...ibcProtoRegistry];

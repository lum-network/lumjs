...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
    ['/lum.network.millions.MsgDeposit', MsgDeposit],
    ...
    ['/lum.network.millions.MsgRestoreInterchainAccounts', MsgRestoreInterchainAccounts],
    ['/lum.network.millions.MsgGenerateSeed', MsgGenerateSeed],
];

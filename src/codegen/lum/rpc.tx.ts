...
export const createRPCMsgClient = async ({
  ...
  lum: {
    network: {
      beam: new (await import("./network/beam/tx.rpc.msg")).MsgClientImpl(rpc),
      dfract: new (await import("./network/dfract/tx.rpc.msg")).MsgClientImpl(rpc),
      millions: new (await import("./network/millions/tx.rpc.msg")).MsgClientImpl(rpc)
    }
  }
});
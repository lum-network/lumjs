...
exports.GenesisState = {
    ...
    fromAmino(object) {
        return {
            groupSeq: helpers_1.Long.fromString(object.group_seq),
            groups: Array.isArray(object?.groups) ? object.groups.map((e) => types_1.GroupInfo.fromAmino(e)) : [],
            groupMembers: Array.isArray(object?.group_members) ? object.group_members.map((e) => types_1.GroupMember.fromAmino(e)) : [],
            groupPolicySeq: helpers_1.Long.fromString(object.group_policy_seq),
            groupPolicies: Array.isArray(object?.group_policies) ? object.group_policies.map((e) => types_1.GroupPolicyInfo.fromAmino(e)) : [],
            proposalSeq: helpers_1.Long.fromString(object.proposal_seq),

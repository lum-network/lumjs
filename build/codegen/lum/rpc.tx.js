...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    lum: {
        network: {
            beam: new (await Promise.resolve().then(() => __importStar(require("./network/beam/tx.rpc.msg")))).MsgClientImpl(rpc),
            dfract: new (await Promise.resolve().then(() => __importStar(require("./network/dfract/tx.rpc.msg")))).MsgClientImpl(rpc),
            millions: new (await Promise.resolve().then(() => __importStar(require("./network/millions/tx.rpc.msg")))).MsgClientImpl(rpc)
        }
    }
});

...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        lum: {
            network: {
                airdrop: (await Promise.resolve().then(() => __importStar(require("./network/airdrop/query.rpc.Query")))).createRpcQueryExtension(client),
                beam: (await Promise.resolve().then(() => __importStar(require("./network/beam/query.rpc.Query")))).createRpcQueryExtension(client),
                dfract: (await Promise.resolve().then(() => __importStar(require("./network/dfract/query.rpc.Query")))).createRpcQueryExtension(client),
                icacallbacks: (await Promise.resolve().then(() => __importStar(require("./network/icacallbacks/query.rpc.Query")))).createRpcQueryExtension(client),
                millions: (await Promise.resolve().then(() => __importStar(require("./network/millions/query.rpc.Query")))).createRpcQueryExtension(client)
            }
        }
    };
};

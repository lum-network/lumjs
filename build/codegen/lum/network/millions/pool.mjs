...
import { drawStateFromJSON } from "./draw";
...
export function poolStateFromJSON(object) {
    switch (object) {
        case 0:
...
export function poolStateToJSON(object) {
    switch (object) {
...
export const Pool = {
    ...
    fromAmino(object) {
        return {
            ...
            validators: Array.isArray(object?.validators) ? object.validators.map((e) => PoolValidator.fromAmino(e)) : [],

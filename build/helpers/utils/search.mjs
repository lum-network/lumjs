 ...
 */
export const searchTxByBlockHeight = (height) => {
 ...
 */
export const searchTxByTags = (tags, minHeight, maxHeight) => {
 ...
 * @param maxHeight max block height (filter)
 */
export const searchTxFrom = (senderAddress, minHeight, maxHeight) => {
    minHeight = minHeight || 0;
    maxHeight = maxHeight || Number.MAX_SAFE_INTEGER;
 ...
 * @param maxHeight max block height (filter)
 */
export const searchTxTo = (recipientAddress, minHeight, maxHeight) => {
    minHeight = minHeight || 0;
    maxHeight = maxHeight || Number.MAX_SAFE_INTEGER;

...
import { toAscii, fromBech32 } from '@cosmjs/encoding';
import { TxRaw, AuthInfo } from '../../codegen/cosmos/tx/v1beta1/tx';
 ...
 */
export const generateAuthInfoBytes = (docSigners, fee, signMode) => {
    const authInfo = {
 ...
 */
export const generateSignDoc = (doc, signerIdx, signMode) => {
 ...
 */
export const generateSignDocBytes = (signDoc) => {
 ...
 */
export const generateSignature = async (hashedMessage, privateKey) => {
 ...
 */
export const generateTxBytes = (signDoc, signatures) => {
 ...
 */
export const verifySignature = async (signature, signedBytes, publicKey) => {
 ...
 */
export const verifySignMsg = async (msg) => {

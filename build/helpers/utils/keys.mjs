 ...
 */
export const getAddressFromPublicKey = (publicKey, prefix = LumBech32PrefixAccAddr) => {
 ...
 */
export const getPublicKeyFromPrivateKey = async (privateKey) => {
 ...
 */
export const getSeedFromMnemonic = async (mnemonic) => {
 ...
 */
export const getPrivateKeyFromSeed = (seed, hdPath = getLumHdPath(0)) => {
 ...
 * @param hdPath derivation path to use
 */
export const getPrivateKeyFromMnemonic = async (mnemonic, hdPath = getLumHdPath(0)) => {
 ...
 */
export const isAddressValid = (address, prefix = LumBech32PrefixAccAddr) => {
    try {
 ...
 */
export const publicKeyToProto = (publicKey) => {
